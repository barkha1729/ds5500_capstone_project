...
from config import DEVICE, CLASSES, TRAIN_DIR
...
if __name__=="__main__":
    ...
    df=pd.read_csv("/home/balaji/manthan/nfl/data/train_labels.csv")
    # path=/home/balaji/manthan/nfl/data/train
    files=[]
    for idx,row in df.iterrows():
        # do something with the file, for example:
        for view in ["Endzone","Sideline"]:
            file="/home/balaji/manthan/nfl/data/train/"+row["game_play"]+"_"+view+".mp4"
            files.append(file)
